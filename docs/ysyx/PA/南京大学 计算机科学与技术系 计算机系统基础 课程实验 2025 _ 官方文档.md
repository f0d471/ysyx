---
title: "南京大学 计算机科学与技术系 计算机系统基础 课程实验 2025 | 官方文档"
source: "https://ysyx.oscc.cc/docs/ics-pa/"
author:
published:
created: 2026-05-16
description:
...
- [常见问题(对PA的各种困惑)](https://ysyx.oscc.cc/docs/ics-pa/FAQ.html)
...
- 实验前请先仔细阅读 [本页面](https://ysyx.oscc.cc/docs/ics-pa/) 以及 [为什么要学习计算机系统基础](https://ysyx.oscc.cc/docs/ics-pa/why.html).
...
- ISA无关的手册
	- [System V generic ABI](https://refspecs.linuxfoundation.org/elf/gabi41.pdf)
		...
		- On-line Manual Pager (即man, [这里](https://ysyx.oscc.cc/docs/ics-pa/man.html) 有一个入门教程)

### GNU/Linux入门教程

jyy为我们准备了一些GNU/Linux入门教程, 如果你是第一次使用GNU/Linux, 请阅读以下材料

- [流传自远古时代的OS实验课程网站中的Linux入门教程](https://ysyx.oscc.cc/docs/ics-pa/linux.html)
