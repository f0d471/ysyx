---
title: "RTFSC"
source: "https://ysyx.oscc.cc/docs/ics-pa/1.3.html"
author:
published:
created: 2026-05-16
description:
...
[这个页面](https://ysyx.oscc.cc/docs/ics-pa/nemu-isa-api.html) 对上述API进行了整理, 供将来查阅使用, 目前你无需完全明白它们的作用. "抽象"是计算机系统中一个非常重要的概念, 如果你现在不明白抽象的意义, 不必担心, 在PA的后续内容中, 你会一次又一次地遇到它.
