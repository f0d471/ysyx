---
title: "B2 SoC计算机系统 | 官方文档"
source: "https://ysyx.oscc.cc/docs/2407/b/2.html"
author:
published:
created: 2026-05-16
description:
...
--- a/src/SoC.scala+++ b/src/SoC.scala
...
![image](images/18-flash-diagram.jpg)
...
另一个例子是型号为 [MTA9ASF51272PZ](https://www.micron.com/-/media/client/global/documents/products/data-sheet/modules/parity_rdimm/asf9c512x72pz.pdf) 的DDR4 SDRAM内存条, 内存条上的颗粒字长是8位, 但通过8个颗粒进行位扩展, 一次可以读写64位.
...
参考PA4阶段1中的选做任务"在RT-Thread上运行AM程序", 尝试在 `riscv32e-ysyxsoc` 中通过RT-Thread启动超级玛丽等其他AM程序.
