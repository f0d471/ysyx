---
title: "E6 完成PA1 | 官方文档"
source: "https://ysyx.oscc.cc/docs/2407/e/6.html"
author:
published:
created: 2026-05-16
description:
...
在做PA之前, 我们强烈建议大家阅读 [PA讲义中的FAQ](https://ysyx.oscc.cc/docs/ics-pa/FAQ.html), 从而对PA有更多的了解.

#### 完成PA1

根据PA讲义完成相关内容(ISA选择默认的 `riscv32`), 包括如下内容:

- [基础设施:简易调试器](https://ysyx.oscc.cc/docs/ics-pa/1.4.html)
- [表达式求值](https://ysyx.oscc.cc/docs/ics-pa/1.5.html)
- [监视点](https://ysyx.oscc.cc/docs/ics-pa/1.6.html)
