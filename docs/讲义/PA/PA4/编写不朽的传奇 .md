---
title: "编写不朽的传奇 | 官方文档"
source: "https://ysyx.oscc.cc/docs/ics-pa/4.5.html"
author:
published:
created: 2026-05-16
description:
...
![onscripter](images/onscripter.b27e3c81.png)
...
事实上, PA中也隐藏了一个并发bug, 我们可以通过以下方式让它暴露出来. 让Nanos-lite加载仙剑奇侠传和NTerm, 然后快速地来回键入 `F1` 和 `F2`, 来回切换仙剑奇侠传和NTerm. 一段时间后, 你可能会观察到绘图不正确的现象: ![NDL bug](images/NDL-bug.b155c8d9.png)
...
![cs-hierarchy](images/cs-hierarchy.d1e0f547.jpg)
