...
> **所属阶段**: F阶段（预学习）
> **原始来源**: [https://ysyx.oscc.cc/docs/2407/f/1.html](https://ysyx.oscc.cc/docs/2407/f/1.html)
> **爬取时间**: 2026-03-27
...
在开始预学习的第一个任务之前，请大家认真阅读官网[《报名参与》]()和[《常见问题》]()两部分内容，并填写[《“一生一芯”通识问卷》]()。**注意：通识问卷可以重做很多次，只有达到100分才能申请入学答辩。**
...
1.  [报名“一生一芯”](). 报名成功后, 你会收到一封邮件, 请根据邮件指引, 创建属于你自己的学习情况记录表
2.  表格创建好后, 请查阅[学习情况记录表使用手册](), 了解如何正确填写和更新你的学习记录.

#### 阅读“提问的智慧”（一生一芯版）

你在预学习中的第一个任务, 就是现在仔细阅读[“提问的智慧”（一生一芯版）]()这篇文章,
...
你可能会觉得字母F冒犯了你, 但事实上这个字母的含义从来都不是重点, 它只是反映出这三个缩写背后的传奇色彩而更容易被大家记住而已. 例如, RTFSC起源于Linux之父Linus Torvalds在1991年4月1日回复邮件中的第一句话, 目前在网上还能搜到当时的邮件列表. 有趣的是, Andrew S. Tanenbaum在[Lessons Learned from 30 Years of MINIX]() 一文中把这封邮件作为MINIX操作系统容易学习的一个例子: 还处于学生时代的Linus Torvalds在10天之内就把MINIX学得差不多了.
...
但幸运的是, 这种能力是可以训练出来的. 你身边的大佬之所以成为了大佬, 是因为他们比你更早地锻炼出独立解决问题的能力: 当你还在向他们请教一个很傻的问题的时候, 他们早就解决过无数个奇葩问题了. 事实上, 你的能力是跟你独立解决问题的投入是成正比的, 大佬告诉你答案, 展示的是大佬的能力, 并不是你的能力. 所以, 要锻炼出独立解决问题的能力, 更重要的是端正自己的心态: 你来参加学习, 你就应该尽自己最大努力独立解决遇到的所有问题 (当然一些由于框架代码缺陷导致的问题除外).
