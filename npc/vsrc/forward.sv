module forward_unit (
    ...
    always_comb begin
        if (ex_wr_en && ex_rd_addr != 5'b0 && ex_rd_addr == id_rs1_addr)
            fwd_rs1_sel = FWD_EX;
        else if (mem_wr_en && mem_rd_addr != 5'b0 && mem_rd_addr == id_rs1_addr)
            fwd_rs1_sel = FWD_MEM;
        else if (wb_wr_en && wb_rd_addr != 5'b0 && wb_rd_addr == id_rs1_addr)
            fwd_rs1_sel = FWD_WB;
        else
    ...
    always_comb begin
        if (ex_wr_en && ex_rd_addr != 5'b0 && ex_rd_addr == id_rs2_addr)
            fwd_rs2_sel = FWD_EX;
        else if (mem_wr_en && mem_rd_addr != 5'b0 && mem_rd_addr == id_rs2_addr)
            fwd_rs2_sel = FWD_MEM;
        else if (wb_wr_en && wb_rd_addr != 5'b0 && wb_rd_addr == id_rs2_addr)
            fwd_rs2_sel = FWD_WB;
        else
