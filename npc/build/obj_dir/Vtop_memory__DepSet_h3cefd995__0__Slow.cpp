...
VL_ATTR_COLD void Vtop_memory___stl_sequent__TOP__top__u_core__u_memory__0(Vtop_memory* vlSelf) {
    ...
    // Body
    vlSelfRef.__PVT__lsu_respReady = (1U == (IData)(vlSelfRef.__PVT__state));
}

VL_ATTR_COLD void Vtop_memory___stl_sequent__TOP__top__u_core__u_memory__1(Vtop_memory* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_memory___stl_sequent__TOP__top__u_core__u_memory__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelfRef.__PVT__is_mem = ((IData)(vlSelfRef.__PVT__is_load) 
                               | (IData)(vlSelfRef.__PVT__is_store));
    vlSelfRef.__PVT__mem_rdata_out = 0U;
    if (((IData)(vlSelfRef.__PVT__is_load) & (2U == (IData)(vlSelfRef.__PVT__state)))) {
        vlSelfRef.__PVT__mem_rdata_out = ((0U == (IData)(vlSelfRef.__PVT__funct3_in))
                                           ? VL_CONCAT_III(32,24,8, 
                                                           (0xffffffU 
                                                            & VL_REPLICATE_IOI(1,
                                                                               (1U 
                                                                                & VL_BITSEL_IIII(32, vlSelfRef.__PVT__rdata_latch, 7U)), 0x18U)), 
                                                           (0xffU 
                                                            & VL_SEL_IIII(32, vlSelfRef.__PVT__rdata_latch, 0U, 8U)))
                                               ...
                                               : ((1U 
                                                  ...
                                                  VL_CONCAT_III(32,16,16, 
                                                                (0xffffU 
                                                                 & VL_REPLICATE_IOI(1,
                                                                                (1U 
                                                                                & VL_BITSEL_IIII(32, vlSelfRef.__PVT__rdata_latch, 0xfU)), 0x10U)), 
                                                                (0xffffU 
                                                                 & VL_SEL_IIII(32, vlSelfRef.__PVT__rdata_latch, 0U, 0x10U)))
                                                   : 
                                                  ((5U 
                                                    == (IData)(vlSelfRef.__PVT__funct3_in))
                                                    ? 
                                                   ...
                                                   ((2U 
                                                     == (IData)(vlSelfRef.__PVT__funct3_in))
                                                     ? vlSelfRef.__PVT__rdata_latch
                                                     : 0U)))));
    }
    vlSelfRef.__PVT__lsu_wmask = vlSelfRef.__PVT__wmask_gen;
    vlSelfRef.__PVT__lsu_reqValid = ((IData)(vlSelfRef.__PVT__is_mem) 
                                     & (0U == (IData)(vlSelfRef.__PVT__state)));
    vlSelfRef.__PVT__lsu_busy = ((IData)(vlSelfRef.__PVT__is_mem) 
                                 & (2U != (IData)(vlSelfRef.__PVT__state)));
    vlSelfRef.__PVT__state_next = vlSelfRef.__PVT__state;
    if ((0U == (IData)(vlSelfRef.__PVT__state))) {
        if ((((IData)(vlSelfRef.__PVT__is_mem) & (IData)(vlSelfRef.__PVT__lsu_reqValid)) 
...
VL_ATTR_COLD void Vtop_memory___ctor_var_reset(Vtop_memory* vlSelf) {
    ...
    vlSelf->__PVT__is_mem = 0;
    vlSelf->__PVT__state = 0;
    vlSelf->__PVT__state_next = 0;
    vlSelf->__PVT__rdata_latch = 0;
    vlSelf->__PVT__wmask_gen = 0;
    vlSelf->__Vdly__state = 0;
    vlSelf->__Vdly__rdata_latch = 0;
}
