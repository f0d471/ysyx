...
VL_ATTR_COLD void Vtop_pipe_reg__D40___stl_sequent__TOP__top__u_core__u_if2id__0(Vtop_pipe_reg__D40* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_pipe_reg__D40___stl_sequent__TOP__top__u_core__u_if2id__0\n"); );
...
VL_ATTR_COLD void Vtop_pipe_reg__D40___stl_sequent__TOP__top__u_core__u_if2id__1(Vtop_pipe_reg__D40* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_pipe_reg__D40___stl_sequent__TOP__top__u_core__u_if2id__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtop_pipe_reg__D40___ctor_var_reset(Vtop_pipe_reg__D40* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_pipe_reg__D40___ctor_var_reset\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->__PVT__clk = 0;
