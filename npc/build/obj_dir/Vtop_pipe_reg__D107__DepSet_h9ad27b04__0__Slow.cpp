...
VL_ATTR_COLD void Vtop_pipe_reg__D107___stl_sequent__TOP__top__u_core__u_id2ex__0(Vtop_pipe_reg__D107* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_pipe_reg__D107___stl_sequent__TOP__top__u_core__u_id2ex__0\n"); );
...
VL_ATTR_COLD void Vtop_pipe_reg__D107___stl_sequent__TOP__top__u_core__u_id2ex__1(Vtop_pipe_reg__D107* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_pipe_reg__D107___stl_sequent__TOP__top__u_core__u_id2ex__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtop_pipe_reg__D107___ctor_var_reset(Vtop_pipe_reg__D107* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_pipe_reg__D107___ctor_var_reset\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->__PVT__clk = 0;
    ...
    VL_ZERO_RESET_W(263, vlSelf->__PVT__up_data);
    vlSelf->__PVT__dn_valid = 0;
    vlSelf->__PVT__dn_ready = 0;
    VL_ZERO_RESET_W(263, vlSelf->__PVT__dn_data);
    VL_ZERO_RESET_W(263, vlSelf->__PVT__data_q);
    vlSelf->__PVT__valid_q = 0;
    vlSelf->__Vdly__valid_q = 0;
    VL_ZERO_RESET_W(263, vlSelf->__Vdly__data_q);
}
