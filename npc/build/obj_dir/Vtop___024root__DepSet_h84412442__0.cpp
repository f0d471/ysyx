...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VactTriggered.set(0U, ((IData)(vlSymsp->TOP__top__u_sram_ifu.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_sram_ifu____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(1U, ((~ (IData)(vlSymsp->TOP__top__u_sram_ifu.__PVT__rst_n)) 
                                       & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_sram_ifu____PVT__rst_n__0)));
    vlSelfRef.__VactTriggered.set(2U, ((IData)(vlSymsp->TOP__top__u_sram_lsu.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_sram_lsu____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(3U, ((~ (IData)(vlSymsp->TOP__top__u_sram_lsu.__PVT__rst_n)) 
                                       & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_sram_lsu____PVT__rst_n__0)));
    vlSelfRef.__VactTriggered.set(4U, ((IData)(vlSymsp->TOP__top__u_core__u_memory.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_memory____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(5U, ((~ (IData)(vlSymsp->TOP__top__u_core__u_memory.__PVT__rst_n)) 
                                       & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_memory____PVT__rst_n__0)));
    vlSelfRef.__VactTriggered.set(6U, ((IData)(vlSymsp->TOP__top__u_core__u_csr_file.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_csr_file____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(7U, ((IData)(vlSymsp->TOP__top__u_core__u_reg_file.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_reg_file____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(8U, ((~ (IData)(vlSymsp->TOP__top__u_core__u_reg_file.__PVT__rst_n)) 
                                       & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_reg_file____PVT__rst_n__0)));
    vlSelfRef.__VactTriggered.set(9U, ((IData)(vlSymsp->TOP__top__u_core__u_fetch.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_fetch____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(0xaU, ((~ (IData)(vlSymsp->TOP__top__u_core__u_fetch.__PVT__rst_n)) 
                                         & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_fetch____PVT__rst_n__0)));
    vlSelfRef.__VactTriggered.set(0xbU, ((IData)(vlSymsp->TOP__top__u_core__u_pc_counter.__PVT__clk) 
                                         & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_pc_counter____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(0xcU, ((~ (IData)(vlSymsp->TOP__top__u_core__u_pc_counter.__PVT__rst_n)) 
                                         & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_pc_counter____PVT__rst_n__0)));
    vlSelfRef.__VactTriggered.set(0xdU, ((IData)(vlSymsp->TOP__top__u_core__u_if2id.__PVT__clk) 
                                         & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_if2id____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(0xeU, ((~ (IData)(vlSymsp->TOP__top__u_core__u_if2id.__PVT__rst_n)) 
                                         & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_if2id____PVT__rst_n__0)));
    vlSelfRef.__VactTriggered.set(0xfU, ((IData)(vlSymsp->TOP__top__u_core__u_id2ex.__PVT__clk) 
                                         & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_id2ex____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(0x10U, ((~ (IData)(vlSymsp->TOP__top__u_core__u_id2ex.__PVT__rst_n)) 
                                          & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_id2ex____PVT__rst_n__0)));
    vlSelfRef.__VactTriggered.set(0x11U, ((IData)(vlSymsp->TOP__top__u_core__u_ex2mem.__PVT__clk) 
                                          & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_ex2mem____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(0x12U, ((~ (IData)(vlSymsp->TOP__top__u_core__u_ex2mem.__PVT__rst_n)) 
                                          & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_ex2mem____PVT__rst_n__0)));
    vlSelfRef.__VactTriggered.set(0x13U, ((IData)(vlSymsp->TOP__top__u_core__u_mem2wb.__PVT__clk) 
                                          & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_mem2wb____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(0x14U, ((~ (IData)(vlSymsp->TOP__top__u_core__u_mem2wb.__PVT__rst_n)) 
...
void Vtop_sim_sram__LBz1_H1___nba_sequent__TOP__top__u_sram_lsu__0(Vtop_sim_sram__LBz1_H1* vlSelf);
...
void Vtop_sim_sram__D1___nba_sequent__TOP__top__u_sram_ifu__0(Vtop_sim_sram__D1* vlSelf);
...
void Vtop_core___nba_comb__TOP__top__u_core__15(Vtop_core* vlSelf);
...
void Vtop___024root___eval_nba(Vtop___024root* vlSelf) {
    ...
    if ((0xcULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vtop_sim_sram__LBz1_H1___nba_sequent__TOP__top__u_sram_lsu__0((&vlSymsp->TOP__top__u_sram_lsu));
    ...
    if ((3ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vtop_sim_sram__D1___nba_sequent__TOP__top__u_sram_ifu__0((&vlSymsp->TOP__top__u_sram_ifu));
    ...
    if ((0x6003cULL & vlSelfRef.__VnbaTriggered.word(0U))) {
    ...
    if ((0x60030ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
    ...
    if ((0x6180ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
    ...
    if ((0x1fe000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vtop_forward_unit___nba_comb__TOP__top__u_core__u_forward__0((&vlSymsp->TOP__top__u_core__u_forward));
    }
    if ((0x1e003cULL & vlSelfRef.__VnbaTriggered.word(0U))) {
    ...
    if ((0x18643ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
    ...
    if ((0x18640ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
    ...
    if ((0x1e040ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vtop_core___nba_comb__TOP__top__u_core__9((&vlSymsp->TOP__top__u_core));
    }
    if ((0x7e03cULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vtop_core___nba_comb__TOP__top__u_core__10((&vlSymsp->TOP__top__u_core));
    }
    if ((0x1fe1fcULL & vlSelfRef.__VnbaTriggered.word(0U))) {
    ...
    if ((0x1f803cULL & vlSelfRef.__VnbaTriggered.word(0U))) {
