...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.__VactTriggered.set(1U, ((IData)(vlSymsp->TOP__top__u_reg_file.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_reg_file____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(2U, ((~ (IData)(vlSymsp->TOP__top__u_reg_file.__PVT__rst_n)) 
                                       & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_reg_file____PVT__rst_n__0)));
    vlSelfRef.__VactTriggered.set(3U, ((IData)(vlSymsp->TOP__top__u_pc_counter.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_pc_counter____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(4U, ((~ (IData)(vlSymsp->TOP__top__u_pc_counter.__PVT__rst_n)) 
