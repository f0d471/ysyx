...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VactTriggered.set(0U, ((IData)(vlSymsp->TOP__top__u_core__u_memory.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_memory____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(1U, ((IData)(vlSymsp->TOP__top__u_core__u_csr_file.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_csr_file____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(2U, ((IData)(vlSymsp->TOP__top__u_core__u_reg_file.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_reg_file____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(3U, ((~ (IData)(vlSymsp->TOP__top__u_core__u_reg_file.__PVT__rst_n)) 
                                       & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_reg_file____PVT__rst_n__0)));
    vlSelfRef.__VactTriggered.set(4U, ((IData)(vlSymsp->TOP__top__u_core__u_pc_counter.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_pc_counter____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(5U, ((~ (IData)(vlSymsp->TOP__top__u_core__u_pc_counter.__PVT__rst_n)) 
                                       & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_pc_counter____PVT__rst_n__0)));
    vlSelfRef.__VactTriggered.set(6U, ((IData)(vlSymsp->TOP__top__u_core__u_if2id.__PVT__clk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_if2id____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(7U, ((~ (IData)(vlSymsp->TOP__top__u_core__u_if2id.__PVT__rst_n)) 
    ...
    vlSelfRef.__VactTriggered.set(0xcU, ((IData)(vlSymsp->TOP__top__u_core__u_mem2wb.__PVT__clk) 
                                         & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__u_core__u_mem2wb____PVT__clk__0))));
    vlSelfRef.__VactTriggered.set(0xdU, ((~ (IData)(vlSymsp->TOP__top__u_core__u_mem2wb.__PVT__rst_n)) 
...
void Vtop___024root___eval_nba(Vtop___024root* vlSelf) {
    ...
    if ((0x302ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
    ...
    if ((0x3fc0ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
    ...
    if ((0x3f00ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
    ...
    if ((0x3c2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vtop_core___nba_comb__TOP__top__u_core__7((&vlSymsp->TOP__top__u_core));
    }
    if ((0x3f2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vtop_core___nba_comb__TOP__top__u_core__8((&vlSymsp->TOP__top__u_core));
    }
    if ((0x3fceULL & vlSelfRef.__VnbaTriggered.word(0U))) {
