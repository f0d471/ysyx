...
VL_INLINE_OPT void Vtop_pipe_reg_id2ex___nba_sequent__TOP__top__u_id2ex__0(Vtop_pipe_reg_id2ex* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_pipe_reg_id2ex___nba_sequent__TOP__top__u_id2ex__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__Vdly__valid_q = vlSelfRef.__PVT__valid_q;
    VL_ASSIGN_W(263,vlSelfRef.__Vdly__data_q, vlSelfRef.__PVT__data_q);
...
VL_INLINE_OPT void Vtop_pipe_reg_id2ex___nba_comb__TOP__top__u_id2ex__0(Vtop_pipe_reg_id2ex* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_pipe_reg_id2ex___nba_comb__TOP__top__u_id2ex__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
