...
VL_INLINE_OPT void Vtop_pc_counter___nba_sequent__TOP__top__u_pc_counter__0(Vtop_pc_counter* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_pc_counter___nba_sequent__TOP__top__u_pc_counter__0\n"); );
