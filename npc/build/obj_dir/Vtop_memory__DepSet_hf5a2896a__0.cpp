...
VL_INLINE_OPT void Vtop_memory___ico_sequent__TOP__top__u_memory__0(Vtop_memory* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_memory___ico_sequent__TOP__top__u_memory__0\n"); );
...
VL_INLINE_OPT void Vtop_memory___nba_comb__TOP__top__u_memory__0(Vtop_memory* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_memory___nba_comb__TOP__top__u_memory__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__rdata_raw = 0U;
    vlSelfRef.__PVT__mem_rdata_out = 0U;
