...
VL_INLINE_OPT void Vtop_pipe_reg_if2id___nba_sequent__TOP__top__u_core__u_if2id__0(Vtop_pipe_reg_if2id* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_pipe_reg_if2id___nba_sequent__TOP__top__u_core__u_if2id__0\n"); );
...
VL_INLINE_OPT void Vtop_pipe_reg_if2id___nba_comb__TOP__top__u_core__u_if2id__0(Vtop_pipe_reg_if2id* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_pipe_reg_if2id___nba_comb__TOP__top__u_core__u_if2id__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
