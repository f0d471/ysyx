...
VL_INLINE_OPT void Vtop_execute___ico_sequent__TOP__top__u_execute__1(Vtop_execute* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_execute___ico_sequent__TOP__top__u_execute__1\n"); );
...
VL_INLINE_OPT void Vtop_execute___nba_comb__TOP__top__u_execute__2(Vtop_execute* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_execute___nba_comb__TOP__top__u_execute__2\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__csr_wdata = ((IData)(vlSelfRef.__PVT__inst_csrrw)
                                   ? vlSelfRef.__PVT__op1_in
