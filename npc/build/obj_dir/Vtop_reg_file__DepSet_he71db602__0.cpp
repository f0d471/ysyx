...
VL_INLINE_OPT void Vtop_reg_file___ico_sequent__TOP__top__u_reg_file__0(Vtop_reg_file* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_reg_file___ico_sequent__TOP__top__u_reg_file__0\n"); );
