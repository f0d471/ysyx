...
VL_INLINE_OPT void Vtop_top___ico_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    vlSymsp->TOP__top__u_if2id.__PVT__clk = vlSelfRef.clk;
    vlSymsp->TOP__top__u_reg_file.__PVT__clk = vlSelfRef.clk;
    vlSymsp->TOP__top__u_id2ex.__PVT__clk = vlSelfRef.clk;
    vlSymsp->TOP__top__u_ex2mem.__PVT__clk = vlSelfRef.clk;
    vlSymsp->TOP__top__u_memory.__PVT__clk = vlSelfRef.clk;
    vlSymsp->TOP__top__u_mem2wb.__PVT__clk = vlSelfRef.clk;
    ...
    vlSymsp->TOP__top__u_if2id.__PVT__rst_n = vlSelfRef.rst_n;
    vlSymsp->TOP__top__u_reg_file.__PVT__rst_n = vlSelfRef.rst_n;
    vlSymsp->TOP__top__u_id2ex.__PVT__rst_n = vlSelfRef.rst_n;
    vlSymsp->TOP__top__u_ex2mem.__PVT__rst_n = vlSelfRef.rst_n;
    vlSymsp->TOP__top__u_mem2wb.__PVT__rst_n = vlSelfRef.rst_n;
...
VL_INLINE_OPT void Vtop_top___ico_sequent__TOP__top__1(Vtop_top* vlSelf) {
    ...
    vlSelfRef.__PVT__if_id_up = VL_CONCAT_QII(64,32,32, vlSelfRef.pc, vlSelfRef.instr);
    vlSymsp->TOP__top__u_if2id.__PVT__up_data = vlSelfRef.__PVT__if_id_up;
}
...
VL_INLINE_OPT void Vtop_top___nba_sequent__TOP__top__4(Vtop_top* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__mem2wb_dn_valid = vlSymsp->TOP__top__u_mem2wb.__PVT__dn_valid;
    vlSelfRef.__PVT__mem2wb_up_ready = vlSymsp->TOP__top__u_mem2wb.__PVT__up_ready;
    VL_ASSIGN_W(76,vlSelfRef.__PVT__mem_wb_dn, vlSymsp->TOP__top__u_mem2wb.__PVT__dn_data);
    vlSymsp->TOP__top__u_ex2mem.__PVT__dn_ready = vlSelfRef.__PVT__mem2wb_up_ready;
    vlSelfRef.__Vcellinp__u_writeback__rd_addr_in = 
        (0x1fU & VL_SEL_IWII(76, vlSelfRef.__PVT__mem_wb_dn, 7U, 5U));
    vlSelfRef.__Vcellinp__u_writeback__opcode_in = 
        (0x7fU & VL_SEL_IWII(76, vlSelfRef.__PVT__mem_wb_dn, 0U, 7U));
    vlSelfRef.__Vcellinp__u_writeback__mem_rdata_in 
        = VL_SEL_IWII(76, vlSelfRef.__PVT__mem_wb_dn, 0xcU, 0x20U);
    vlSelfRef.__Vcellinp__u_writeback__alu_result_in 
        = VL_SEL_IWII(76, vlSelfRef.__PVT__mem_wb_dn, 0x2cU, 0x20U);
    vlSelfRef.__Vcellinp__u_forward__wb_opcode = (0x7fU 
                                                  & VL_SEL_IWII(76, vlSelfRef.__PVT__mem_wb_dn, 0U, 7U));
    vlSelfRef.__Vcellinp__u_forward__wb_rd_addr = (0x1fU 
                                                   & VL_SEL_IWII(76, vlSelfRef.__PVT__mem_wb_dn, 7U, 5U));
    ...
    vlSymsp->TOP__top__u_writeback.__PVT__alu_result_in 
        = vlSelfRef.__Vcellinp__u_writeback__alu_result_in;
    vlSymsp->TOP__top__u_forward.__PVT__wb_opcode = vlSelfRef.__Vcellinp__u_forward__wb_opcode;
    vlSymsp->TOP__top__u_forward.__PVT__wb_rd_addr 
...
VL_INLINE_OPT void Vtop_top___nba_sequent__TOP__top__6(Vtop_top* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__ex2mem_dn_valid = vlSymsp->TOP__top__u_ex2mem.__PVT__dn_valid;
    VL_ASSIGN_W(79,vlSelfRef.__PVT__ex_mem_dn, vlSymsp->TOP__top__u_ex2mem.__PVT__dn_data);
    vlSymsp->TOP__top__u_mem2wb.__PVT__up_valid = vlSelfRef.__PVT__ex2mem_dn_valid;
    vlSelfRef.__Vcellinp__u_memory__rs2_data_in = VL_SEL_IWII(79, vlSelfRef.__PVT__ex_mem_dn, 0xfU, 0x20U);
    VL_ASSIGNSEL_WI(76,7,0U, vlSelfRef.__PVT__mem_wb_up, 
                    (0x7fU & VL_SEL_IWII(79, vlSelfRef.__PVT__ex_mem_dn, 3U, 7U)));
    vlSelfRef.__Vcellinp__u_memory__funct3_in = (7U 
                                                 & VL_SEL_IWII(79, vlSelfRef.__PVT__ex_mem_dn, 0U, 3U));
    vlSelfRef.__Vcellinp__u_memory__opcode_in = (0x7fU 
                                                 & VL_SEL_IWII(79, vlSelfRef.__PVT__ex_mem_dn, 3U, 7U));
    vlSelfRef.__Vcellinp__u_memory__alu_result_in = 
        VL_SEL_IWII(79, vlSelfRef.__PVT__ex_mem_dn, 0x2fU, 0x20U);
    vlSelfRef.__Vcellinp__u_forward__mem_opcode = (0x7fU 
                                                   & VL_SEL_IWII(79, vlSelfRef.__PVT__ex_mem_dn, 3U, 7U));
    vlSelfRef.__Vcellinp__u_forward__mem_rd_addr = 
        (0x1fU & VL_SEL_IWII(79, vlSelfRef.__PVT__ex_mem_dn, 0xaU, 5U));
    vlSymsp->TOP__top__u_memory.__PVT__rs2_data_in 
        = vlSelfRef.__Vcellinp__u_memory__rs2_data_in;
    vlSymsp->TOP__top__u_memory.__PVT__funct3_in = vlSelfRef.__Vcellinp__u_memory__funct3_in;
    vlSymsp->TOP__top__u_memory.__PVT__opcode_in = vlSelfRef.__Vcellinp__u_memory__opcode_in;
    vlSymsp->TOP__top__u_memory.__PVT__alu_result_in 
        = vlSelfRef.__Vcellinp__u_memory__alu_result_in;
    vlSymsp->TOP__top__u_forward.__PVT__mem_opcode 
        = vlSelfRef.__Vcellinp__u_forward__mem_opcode;
    vlSymsp->TOP__top__u_forward.__PVT__mem_rd_addr 
        = vlSelfRef.__Vcellinp__u_forward__mem_rd_addr;
}
...
VL_INLINE_OPT void Vtop_top___nba_sequent__TOP__top__7(Vtop_top* vlSelf) {
    ...
    VL_CONCAT_WQI(69,64,5, __Vtemp_1, VL_CONCAT_QII(64,32,32, 
                                                    VL_SEL_IWII(79, vlSelfRef.__PVT__ex_mem_dn, 0x2fU, 0x20U), vlSelfRef.__PVT__mem_rdata), 
                  (0x1fU & VL_SEL_IWII(79, vlSelfRef.__PVT__ex_mem_dn, 0xaU, 5U)));
    VL_ASSIGNSEL_WW(76,69,7U, vlSelfRef.__PVT__mem_wb_up, __Vtemp_1);
    VL_ASSIGN_W(76,vlSymsp->TOP__top__u_mem2wb.__PVT__up_data, vlSelfRef.__PVT__mem_wb_up);
}
...
VL_INLINE_OPT void Vtop_top___nba_sequent__TOP__top__8(Vtop_top* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__id2ex_dn_valid = vlSymsp->TOP__top__u_id2ex.__PVT__dn_valid;
    VL_ASSIGN_W(263,vlSelfRef.__PVT__id_ex_dn, vlSymsp->TOP__top__u_id2ex.__PVT__dn_data);
    vlSymsp->TOP__top__u_ex2mem.__PVT__up_valid = vlSelfRef.__PVT__id2ex_dn_valid;
    VL_ASSIGNSEL_WI(79,10,0U, vlSelfRef.__PVT__ex_mem_up, 
                    VL_CONCAT_III(10,7,3, (0x7fU & 
    ...
    vlSymsp->TOP__top__u_execute.__PVT__inst_ebreak_in 
        = vlSelfRef.__Vcellinp__u_execute__inst_ebreak_in;
    vlSymsp->TOP__top__u_hazard.__PVT__ex_opcode = vlSelfRef.__Vcellinp__u_hazard__ex_opcode;
    vlSymsp->TOP__top__u_execute.__PVT__inst_mret = vlSelfRef.__Vcellinp__u_execute__inst_mret;
    vlSymsp->TOP__top__u_execute.__PVT__imm_in = vlSelfRef.__Vcellinp__u_execute__imm_in;
    ...
    vlSymsp->TOP__top__u_execute.__PVT__pc_in = vlSelfRef.__Vcellinp__u_execute__pc_in;
    vlSymsp->TOP__top__u_hazard.__PVT__ex_rd_addr = vlSelfRef.__Vcellinp__u_hazard__ex_rd_addr;
    vlSymsp->TOP__top__u_execute.__PVT__funct7_in = vlSelfRef.__Vcellinp__u_execute__funct7_in;
    ...
    vlSymsp->TOP__top__u_execute.__PVT__csr_addr_in 
        = vlSelfRef.__Vcellinp__u_execute__csr_addr_in;
    vlSymsp->TOP__top__u_execute.__PVT__funct3_in = vlSelfRef.__Vcellinp__u_execute__funct3_in;
    vlSymsp->TOP__top__u_execute.__PVT__op2_in = vlSelfRef.__Vcellinp__u_execute__op2_in;
    vlSymsp->TOP__top__u_execute.__PVT__op1_in = vlSelfRef.__Vcellinp__u_execute__op1_in;
    vlSymsp->TOP__top__u_execute.__PVT__opcode_in = vlSelfRef.__Vcellinp__u_execute__opcode_in;
    vlSymsp->TOP__top__u_forward.__PVT__ex_stage_opcode 
        = vlSelfRef.__Vcellinp__u_forward__ex_stage_opcode;
    vlSymsp->TOP__top__u_forward.__PVT__ex_stage_rd_addr 
        = vlSelfRef.__Vcellinp__u_forward__ex_stage_rd_addr;
}
...
VL_INLINE_OPT void Vtop_top___nba_sequent__TOP__top__10(Vtop_top* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__if2id_dn_valid = vlSymsp->TOP__top__u_if2id.__PVT__dn_valid;
    vlSelfRef.__PVT__if_id_dn = vlSymsp->TOP__top__u_if2id.__PVT__dn_data;
    vlSymsp->TOP__top__u_id2ex.__PVT__up_valid = vlSelfRef.__PVT__if2id_dn_valid;
    ...
    vlSymsp->TOP__top__u_decode.__PVT__instr_addr_in 
        = vlSelfRef.__Vcellinp__u_decode__instr_addr_in;
    vlSymsp->TOP__top__u_decode.__PVT__instr_in = vlSelfRef.__Vcellinp__u_decode__instr_in;
}
...
VL_INLINE_OPT void Vtop_top___nba_sequent__TOP__top__11(Vtop_top* vlSelf) {
    ...
    vlSelfRef.__PVT__decode_inst_ebreak = vlSymsp->TOP__top__u_decode.__PVT__inst_ebreak;
...
VL_INLINE_OPT void Vtop_top___nba_comb__TOP__top__0(Vtop_top* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__ex2mem_up_ready = vlSymsp->TOP__top__u_ex2mem.__PVT__up_ready;
    vlSymsp->TOP__top__u_id2ex.__PVT__dn_ready = vlSelfRef.__PVT__ex2mem_up_ready;
}
...
VL_INLINE_OPT void Vtop_top___nba_comb__TOP__top__1(Vtop_top* vlSelf) {
    ...
    vlSymsp->TOP__top__u_if2id.__PVT__flush = vlSelfRef.__PVT__ex_jump_flag;
...
VL_INLINE_OPT void Vtop_top___nba_comb__TOP__top__2(Vtop_top* vlSelf) {
    ...
    VL_CONCAT_WQI(69,64,5, __Vtemp_1, VL_CONCAT_QII(64,32,32, vlSelfRef.__PVT__ex_alu_result, 
                                                    VL_SEL_IWII(263, vlSelfRef.__PVT__id_ex_dn, 0x11U, 0x20U)), 
                  (0x1fU & VL_SEL_IWII(263, vlSelfRef.__PVT__id_ex_dn, 0x82U, 5U)));
    VL_ASSIGNSEL_WW(79,69,0xaU, vlSelfRef.__PVT__ex_mem_up, __Vtemp_1);
    VL_ASSIGN_W(79,vlSymsp->TOP__top__u_ex2mem.__PVT__up_data, vlSelfRef.__PVT__ex_mem_up);
}
...
VL_INLINE_OPT void Vtop_top___nba_comb__TOP__top__3(Vtop_top* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__load_stall = vlSymsp->TOP__top__u_hazard.__PVT__stall;
    vlSymsp->TOP__top__u_if2id.__PVT__stall = vlSelfRef.__PVT__load_stall;
}
...
VL_INLINE_OPT void Vtop_top___nba_comb__TOP__top__5(Vtop_top* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__fwd_rs1_sel = vlSymsp->TOP__top__u_forward.__PVT__fwd_rs1_sel;
    vlSelfRef.__PVT__fwd_rs2_sel = vlSymsp->TOP__top__u_forward.__PVT__fwd_rs2_sel;
}
...
VL_INLINE_OPT void Vtop_top___nba_comb__TOP__top__6(Vtop_top* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__id2ex_up_ready = vlSymsp->TOP__top__u_id2ex.__PVT__up_ready;
    vlSymsp->TOP__top__u_if2id.__PVT__dn_ready = vlSelfRef.__PVT__id2ex_up_ready;
}
...
VL_INLINE_OPT void Vtop_top___nba_comb__TOP__top__7(Vtop_top* vlSelf) {
    ...
    vlSymsp->TOP__top__u_id2ex.__PVT__flush = vlSelfRef.__Vcellinp__u_id2ex__flush;
}
...
VL_INLINE_OPT void Vtop_top___nba_comb__TOP__top__8(Vtop_top* vlSelf) {
    ...
    vlSelfRef.__Vcellinp__u_pc_counter__jump_addr = 
        ((IData)(vlSelfRef.__PVT__load_stall) ? vlSelfRef.pc
...
VL_INLINE_OPT void Vtop_top___nba_comb__TOP__top__9(Vtop_top* vlSelf) {
    ...
    VL_CONCAT_WIQ(74,10,64, __Vtemp_1, VL_CONCAT_III(10,3,7, (IData)(vlSelfRef.__PVT__decode_funct3), (IData)(vlSelfRef.__PVT__decode_funct7)), 
                  VL_CONCAT_QII(64,32,32, vlSelfRef.__PVT__fwd_rs1_data, vlSelfRef.__PVT__fwd_rs2_data));
    VL_ASSIGNSEL_WW(263,74,0x11U, vlSelfRef.__PVT__id_ex_up, __Vtemp_1);
    ...
    VL_ASSIGNSEL_WW(263,96,0xa7U, vlSelfRef.__PVT__id_ex_up, __Vtemp_2);
    VL_CONCAT_WIQ(76,32,44, __Vtemp_3, vlSelfRef.__PVT__id_op2, 
    ...
    VL_ASSIGN_W(263,vlSymsp->TOP__top__u_id2ex.__PVT__up_data, vlSelfRef.__PVT__id_ex_up);
}
...
VL_INLINE_OPT void Vtop_top___nba_comb__TOP__top__10(Vtop_top* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__if2id_up_ready = vlSymsp->TOP__top__u_if2id.__PVT__up_ready;
}
