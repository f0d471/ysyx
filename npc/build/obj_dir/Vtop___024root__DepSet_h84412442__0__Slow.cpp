...
VL_ATTR_COLD void Vtop___024root___eval_stl(Vtop___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        ...
        Vtop_memory___stl_sequent__TOP__top__u_core__u_memory__1((&vlSymsp->TOP__top__u_core__u_memory));
        ...
        Vtop_fetch___stl_sequent__TOP__top__u_core__u_fetch__2((&vlSymsp->TOP__top__u_core__u_fetch));
