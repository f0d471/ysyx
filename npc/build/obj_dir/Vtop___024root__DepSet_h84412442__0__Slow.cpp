...
VL_ATTR_COLD void Vtop_top___stl_sequent__TOP__top__12(Vtop_top* vlSelf);
VL_ATTR_COLD void Vtop_writeback___stl_sequent__TOP__top__u_writeback__0(Vtop_writeback* vlSelf);
VL_ATTR_COLD void Vtop_top___stl_sequent__TOP__top__13(Vtop_top* vlSelf);
...
VL_ATTR_COLD void Vtop___024root___eval_stl(Vtop___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        ...
        Vtop_top___stl_sequent__TOP__top__12((&vlSymsp->TOP__top));
        Vtop_writeback___stl_sequent__TOP__top__u_writeback__0((&vlSymsp->TOP__top__u_writeback));
        Vtop_top___stl_sequent__TOP__top__13((&vlSymsp->TOP__top));
    }
}
