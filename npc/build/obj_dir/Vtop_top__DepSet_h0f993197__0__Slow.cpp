...
VL_ATTR_COLD void Vtop_top___eval_initial__TOP__top(Vtop_top* vlSelf) {
    ...
    // Body
    vlSymsp->TOP__top__u_if2id.__PVT__up_valid = 1U;
    vlSymsp->TOP__top__u_ex2mem.__PVT__flush = 0U;
    vlSymsp->TOP__top__u_mem2wb.__PVT__dn_ready = 1U;
    vlSymsp->TOP__top__u_mem2wb.__PVT__flush = 0U;
}
...
VL_ATTR_COLD void Vtop_top___stl_sequent__TOP__top__0(Vtop_top* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__trap_cause = vlSymsp->TOP__top__u_execute.__PVT__trap_cause;
    vlSymsp->TOP__top__u_csr_file.__PVT__trap_cause 
