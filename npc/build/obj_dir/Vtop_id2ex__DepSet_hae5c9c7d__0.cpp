...
VL_INLINE_OPT void Vtop_id2ex___ico_sequent__TOP__top__u_id2ex__0(Vtop_id2ex* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_id2ex___ico_sequent__TOP__top__u_id2ex__0\n"); );
...
VL_INLINE_OPT void Vtop_id2ex___nba_comb__TOP__top__u_id2ex__0(Vtop_id2ex* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_id2ex___nba_comb__TOP__top__u_id2ex__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__instr_addr_out = vlSelfRef.__PVT__instr_addr_in;
    vlSelfRef.__PVT__instr_out = vlSelfRef.__PVT__instr_in;
