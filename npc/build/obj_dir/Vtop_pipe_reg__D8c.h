...
#ifndef VERILATED_VTOP_PIPE_REG__D8C_H_
#define VERILATED_VTOP_PIPE_REG__D8C_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_pipe_reg__D8c final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtop_pipe_reg__D8c(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_pipe_reg__D8c();
    VL_UNCOPYABLE(Vtop_pipe_reg__D8c);
